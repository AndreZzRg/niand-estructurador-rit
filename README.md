...
# 📘 Estructurador de RIT

**Reglamento Interno de Trabajo conforme al CST y a la Ley 2466 de 2025**

Laboratorio 07 de la suite de cumplimiento operable de **NiAnd Labs S.A.S.**

[![CI](https://github.com/AndreZzRg/niand-estructurador-rit/actions/workflows/ci.yml/badge.svg)](https://github.com/AndreZzRg/niand-estructurador-rit/actions/workflows/ci.yml)
[![Pages](https://github.com/AndreZzRg/niand-estructurador-rit/actions/workflows/pages.yml/badge.svg)](https://github.com/AndreZzRg/niand-estructurador-rit/actions/workflows/pages.yml)
[![CodeQL](https://github.com/AndreZzRg/niand-estructurador-rit/actions/workflows/codeql.yml/badge.svg)](https://github.com/AndreZzRg/niand-estructurador-rit/actions/workflows/codeql.yml)
...
### [▶ Abrir la aplicación](https://andrezzrg.github.io/niand-estructurador-rit/)
...
Asistente guiado que estructura un Reglamento Interno de Trabajo capítulo por capítulo según el artículo 108 del CST y las obligaciones incorporadas por la Ley 2466 de 2025, valida la completitud del contenido mínimo y exporta el articulado en Markdown y HTML listo para revisión profesional.
...
```bash
git clone https://github.com/AndreZzRg/niand-estructurador-rit.git
cd niand-estructurador-rit
npm install
npm run dev
```
...
```bash
# Con GitHub CLI
gh repo create AndreZzRg/niand-estructurador-rit --public --source=. --remote=origin --push

# O de forma manual, si ya creó el repositorio vacío en github.com
git remote add origin https://github.com/AndreZzRg/niand-estructurador-rit.git
git branch -M main
...
```
https://andrezzrg.github.io/niand-estructurador-rit/
```
...
| **Código Sustantivo del Trabajo, art. 108** | Contenido mínimo obligatorio del Reglamento Interno de Trabajo. |
| **Código Sustantivo del Trabajo, arts. 104 a 125** | Régimen del reglamento, publicación y sanciones. |
| **Ley 2466 de 2025** | Jornada nocturna, recargos, licencias y debido proceso disciplinario. |
| **Ley 2191 de 2022** | Derecho a la desconexión laboral. |
| **Ley 1010 de 2006 y Ley 2365 de 2024** | Mecanismos de prevención del acoso laboral y sexual. |
