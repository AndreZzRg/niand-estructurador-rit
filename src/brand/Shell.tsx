...
export const MODULOS = [
  { id: 'perfil-de-la-empresa', rotulo: 'Perfil de la empresa' },
  { id: 'capitulos', rotulo: 'Capítulos' },
  { id: 'validacion-de-contenido-minimo', rotulo: 'Validación de contenido mínimo' },
  { id: 'vista-previa-del-articulado', rotulo: 'Vista previa del articulado' },
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <header className="no-imprimir sticky top-0 z-30 border-b border-borde bg-superficie/92 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 sm:px-6">
          <a
            href="https://github.com/AndreZzRg/niand-estructurador-rit"
            className="shrink-0"
            aria-label="Repositorio de Estructurador de RIT"
          >
            <Logo alto={28} />
          </a>
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate font-display text-sm font-semibold">
              <span aria-hidden>📘 </span>Estructurador de RIT
            </p>
