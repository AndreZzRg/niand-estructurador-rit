# Arquitectura — Estructurador de RIT
...
Una carpeta por módulo: `perfil-de-la-empresa`, `capitulos`, `validacion-de-contenido-minimo`, `vista-previa-del-articulado`, `exportacion`.
...
`localStorage` bajo claves con prefijo `niand-estructurador-rit:`.
